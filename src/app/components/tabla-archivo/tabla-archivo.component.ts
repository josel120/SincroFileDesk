...
export class TablaArchivoComponent implements OnInit {
    ...
    {position: 1, name: 'Hydrogen', weight: 1.0079, symbol: 'archivo'},
    {position: 2, name: 'Helium', weight: 4.0026, symbol: 'carpeta'},
    {position: 3, name: 'Lithium', weight: 6.941, symbol: 'carpeta'},
    {position: 4, name: 'Beryllium', weight: 9.0122, symbol: 'archivo'},
    {position: 5, name: 'Boron', weight: 10.811, symbol: 'archivo'},
    {position: 6, name: 'Carbon', weight: 12.0107, symbol: 'carpeta'},
    {position: 7, name: 'Nitrogen', weight: 14.0067, symbol: 'carpeta'},
    {position: 8, name: 'Oxygen', weight: 15.9994, symbol: 'carpeta'},
    {position: 9, name: 'Fluorine', weight: 18.9984, symbol: 'carpeta'},
    {position: 10, name: 'Neon', weight: 20.1797, symbol: 'archivo'},
  ];
